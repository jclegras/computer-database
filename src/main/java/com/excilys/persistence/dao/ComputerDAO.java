...
public enum ComputerDAO implements DAO<Computer, Long> {
    ...
    public List<Computer> getAll(Page page) {
        ...
        try (final Connection connection = compDtbConnection.getInstance();
             final PreparedStatement pStatement = connection.prepareStatement(request)) {
    ...
    public Computer getById(Long id) {
        ...
        try (final Connection connection = compDtbConnection.getInstance();
             final PreparedStatement pStatement = connection.prepareStatement(GET_BY_ID_COMPUTER)) {
    ...
    public void create(Computer entity) {
        ...
        try {
            ...
            try (final PreparedStatement pStatement = connection.prepareStatement(CREATE_COMPUTER,
    ...
    public void update(Computer entity) {
        ...
        try {
            connection = compDtbConnection.getInstance();
            try (final PreparedStatement pStatement = connection.prepareStatement(UPDATE_COMPUTER)) {
    ...
    public void delete(Long id) {
        ...
        try {
            connection = compDtbConnection.getInstance();
            try (final PreparedStatement pStatement = connection.prepareStatement(DELETE_COMPUTER)) {
                pStatement.setLong(1, id);
                pStatement.execute();
